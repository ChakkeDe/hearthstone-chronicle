...
const QUESTS=[
  {name:'Border Skirmish',minP:5, t:45, rew:{gold:30,iron:10},  xp:20, danger:.1,  desc:'Drive off raiders from the northern pass.'},
  {name:'Forest Hunt',    minP:8, t:75, rew:{food:50,wood:30},  xp:35, danger:.15, desc:'Hunt the beasts plaguing eastern villages.'},
  {name:'Dungeon Delve',  minP:10,t:120,rew:{iron:25,gold:40},  xp:45, danger:.2,  desc:'Descend into the ruins beneath Harrowmere.'},
