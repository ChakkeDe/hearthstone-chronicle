...
const NPC_FARMS=[
  ...
  {id:'n6',name:'Orc Stronghold',  icon:'🏯',level:5,def:400,loot:{gold:200,iron:100,food:80}, tribute:{gold:7.5,iron:3.8,food:3.2}, controlNeed:160, respawn:1200,available:true,respawnAt:0},
];
