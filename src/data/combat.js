...
const NPC_FARMS=[
  ...
  {id:'s1',name:'Blackcrag Watch', icon:'🗼',kind:'stronghold',level:6,def:2200,lootScale:{gold:0.14,wood:0.1,iron:0.08}, controlNeed:220, captureWeek:4, seasonalRenown:250, respawn:1200,available:true,respawnAt:0},
  {id:'s2',name:'Ashen Bastion',   icon:'🏯',kind:'stronghold',level:7,def:3800,lootScale:{gold:0.16,food:0.12,iron:0.11,mana:0.05}, controlNeed:280, captureWeek:5, seasonalRenown:400, respawn:1500,available:true,respawnAt:0},
  {id:'s3',name:'Gorgath Citadel', icon:'🏰',kind:'stronghold',level:8,def:5800,lootScale:{gold:0.18,food:0.14,iron:0.14,mana:0.08}, controlNeed:340, captureWeek:6, seasonalRenown:650, respawn:1800,available:true,respawnAt:0},
